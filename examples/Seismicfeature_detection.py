...
imgnames     = ['imagetest_withtrap.png','synthetic_model1.png']
...
for imgname in imgnames:
    ...
    traps     = trap_cascade.detectMultiScale(gray, scaleFactor=1.1, minNeighbors=4, maxSize=(150,150) , minSize=(80, 80))
